...
export class FormTrainingClient {
    ...
    async getAccountProperties(options) {
        ...
        try {
            const result = await this.client.getCustomModels(Object.assign({}, operationOptionsToRequestOptionsBase(finalOptions)));
            return {
    ...
    async getCustomModel(modelId, options = {}) {
        ...
        try {
            const response = await this.client.getCustomModel(modelId, Object.assign(Object.assign({}, operationOptionsToRequestOptionsBase(finalOptions)), { 
    ...
    async list(options) {
        ...
        try {
            const result = await this.client.listCustomModels(Object.assign({}, operationOptionsToRequestOptionsBase(finalOptions)));
            return result;
        }
        catch (e) {
            span.setStatus({
    ...
    async listNextPage(nextLink, options) {
        ...
        try {
            const result = await this.client.listCustomModelsNext(nextLink, Object.assign({}, operationOptionsToRequestOptionsBase(finalOptions)));
            return result;
        }
        catch (e) {
            span.setStatus({
    ...
    async getCopyAuthorization(resourceId, resourceRegion, options = {}) {
        ...
        try {
            const response = (await this.client.generateModelCopyAuthorization(operationOptionsToRequestOptionsBase(finalOptions)));
            return {
    ...
    async getCopyModelResult(modelId, resultId, options = {}) {
        ...
        try {
            return await this.client.getCustomModelCopyResult(modelId, resultId, operationOptionsToRequestOptionsBase(finalOptions));
        }
        catch (e) {
            span.setStatus({
                code: SpanStatusCode.ERROR,
