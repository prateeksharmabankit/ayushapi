...
export class FormRecognizerClient {
    ...
    async beginRecognizeCustomForms(modelId, form, options = {}) {
        ...
        const poller = new FormRecognitionPoller(Object.assign({ modelId, createOperation: span("customFormsInternal", async (finalOptions) => {
                ...
                return processOperationLocation(await this.client.analyzeWithCustomModel(modelId, contentType, requestBody, operationOptionsToRequestOptionsBase(finalOptions)));
            ...
            modelIdParam, resultId, operationOptionsToRequestOptionsBase(finalOptions))) }, options));
        await poller.poll();
        return poller;
    }
    /**
    ...
    async beginRecognizeBusinessCards(businessCard, options = { includeFieldElements: false }) {
        ...
        const poller = new FormRecognitionPoller(Object.assign({ expectedDocType: "prebuilt:businesscard", createOperation: span("businessCardsInternal", async (finalOptions) => {
                ...
                const contentType = (_a = finalOptions.contentType) !== null && _a !== void 0 ? _a : (await getContentType(requestBody));
                return processOperationLocation(await this.client.analyzeBusinessCardAsync(contentType, requestBody, operationOptionsToRequestOptionsBase(finalOptions)));
            }), getResult: span("getBusinessCards", async (finalOptions, resultId) => this.client.getAnalyzeBusinessCardResult(resultId, operationOptionsToRequestOptionsBase(finalOptions))) }, options));
        await poller.poll();
        return poller;
    }
    /**
    ...
    async beginRecognizeInvoices(invoice, options = {}) {
        ...
        const poller = new FormRecognitionPoller(Object.assign({ expectedDocType: "prebuilt:invoice", createOperation: span("invoicesInternal", async (finalOptions) => {
                ...
                const contentType = (_a = finalOptions.contentType) !== null && _a !== void 0 ? _a : (await getContentType(requestBody));
                return processOperationLocation(await this.client.analyzeInvoiceAsync(contentType, requestBody, operationOptionsToRequestOptionsBase(finalOptions)));
            }), getResult: span("getInvoices", async (finalOptions, resultId) => this.client.getAnalyzeInvoiceResult(resultId, operationOptionsToRequestOptionsBase(finalOptions))) }, options));
        await poller.poll();
        return poller;
    }
    /**
    ...
    async beginRecognizeIdentityDocuments(identityDocument, options = {}) {
        ...
        const poller = new FormRecognitionPoller(Object.assign({ expectedDocType: "prebuilt:idDocument", createOperation: span("identityDocumentsInternal", async (finalOptions) => {
                ...
                const contentType = (_a = finalOptions.contentType) !== null && _a !== void 0 ? _a : (await getContentType(requestBody));
                return processOperationLocation(await this.client.analyzeIdDocumentAsync(contentType, requestBody, operationOptionsToRequestOptionsBase(finalOptions)));
            }), getResult: span("getIdentityDocuments", async (finalOptions, resultId) => this.client.getAnalyzeIdDocumentResult(resultId, operationOptionsToRequestOptionsBase(finalOptions))) }, options));
        await poller.poll();
        return poller;
    }
    /**
    ...
    async beginRecognizeIdentityDocumentsFromUrl(identityDocumentUrl, options = {}) {
        ...
        const poller = new FormRecognitionPoller(Object.assign({ expectedDocType: "prebuilt:idDocument", createOperation: span("identityDocumentsInternal", async (finalOptions) => {
            ...
            }), getResult: span("getIdDocuments", async (finalOptions, resultId) => this.client.getAnalyzeIdDocumentResult(resultId, operationOptionsToRequestOptionsBase(finalOptions))) }, options));
        await poller.poll();
        return poller;
    }
    // #endregion
    ...
    async beginRecognizeReceipts(receipt, options = {}) {
        ...
        const poller = new FormRecognitionPoller(Object.assign({ expectedDocType: "prebuilt:receipt", createOperation: span("receiptsInternal", async (finalOptions) => {
                ...
                const contentType = (_a = finalOptions.contentType) !== null && _a !== void 0 ? _a : (await getContentType(requestBody));
                return processOperationLocation(await this.client.analyzeReceiptAsync(contentType, requestBody, operationOptionsToRequestOptionsBase(finalOptions)));
            }), getResult: span("getReceipts", async (finalOptions, resultId) => this.client.getAnalyzeReceiptResult(resultId, operationOptionsToRequestOptionsBase(finalOptions))) }, options));
        await poller.poll();
        return poller;
    }
    /**
...
client, body, contentType, options, _modelId) {
    ...
    try {
        if (requestContentType) {
            return await client.analyzeLayoutAsync(requestContentType, requestBody, operationOptionsToRequestOptionsBase(finalOptions));
        }
        return await client.analyzeLayoutAsync("application/json", Object.assign({ fileStream: requestBody }, operationOptionsToRequestOptionsBase(finalOptions)));
    }
    catch (e) {
        span.setStatus({
            code: SpanStatusCode.ERROR,
